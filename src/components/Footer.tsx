...
export default function Footer() {
  return (
    <nav
      className={`flex w-full h-[10svh] md:h-[15svh] ${BACKGROUND_PRIMARY} `}
    >
      <div className={`h-full w-1/2 ${BACKGROUND_SECONDARY}`}>
        <div
          className={`flex md:flex-col ${BACKGROUND_PRIMARY} ${TEXT_PRIMARY} h-full px-10 rounded-br-[5svh] gap-6 items-center md:items-stretch justify-start`}
        >
          <Link
